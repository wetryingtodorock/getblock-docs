---
title: /wallet/exchangeinject  {disallowed} - TRON
description: Example code for the /wallet/exchangeinject  {disallowed} rest method. Сomplete guide on how to use /wallet/exchangeinject  {disallowed} rest in GetBlock.io Web3 documentation.
---
