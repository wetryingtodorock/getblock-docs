...
description: Example code for the /wallet/getblockbynum rest method. Сomplete guide on how to use /wallet/getblockbynum rest in GetBlock.io Web3 documentation.
---
...
``` java
curl --location --request POST 'https://trx.getblock.io/wallet/getblockbynum' \
--header 'x-api-key: YOUR-API-KEY' \
--header 'Content-Type: application/json' \
--data-raw '{"num": 30864544}'
```
