---
title: dash:protx_register_submit  {disallowed} - Dash
description: Example code for the dash:protx_register_submit  {disallowed} json-rpc method. Сomplete guide on how to use dash:protx_register_submit  {disallowed} json-rpc in GetBlock.io Web3 documentation.
---
