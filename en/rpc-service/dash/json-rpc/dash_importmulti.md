---
title: dash:importmulti  {disallowed} - Dash
description: Example code for the dash:importmulti  {disallowed} json-rpc method. Сomplete guide on how to use dash:importmulti  {disallowed} json-rpc in GetBlock.io Web3 documentation.
---
