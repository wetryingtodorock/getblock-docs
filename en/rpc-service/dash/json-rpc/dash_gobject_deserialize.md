---
title: gobject_deserialize - Dash
description: Example code for the gobject_deserialize json-rpc method. Сomplete guide on how to use gobject_deserialize json-rpc in GetBlock.io Web3 documentation.
---
