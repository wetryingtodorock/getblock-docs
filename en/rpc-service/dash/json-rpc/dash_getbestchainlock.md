---
title: dash:getbestchainlock - Dash
description: Example code for the dash:getbestchainlock json-rpc method. Сomplete guide on how to use dash:getbestchainlock json-rpc in GetBlock.io Web3 documentation.
---
