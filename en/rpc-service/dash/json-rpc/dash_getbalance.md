---
title: dash:getbalance  {disallowed} - Dash
description: Example code for the dash:getbalance  {disallowed} json-rpc method. Сomplete guide on how to use dash:getbalance  {disallowed} json-rpc in GetBlock.io Web3 documentation.
---
