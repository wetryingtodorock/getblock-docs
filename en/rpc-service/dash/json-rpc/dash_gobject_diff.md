---
title: dash:gobject_diff - Dash
description: Example code for the dash:gobject_diff json-rpc method. Сomplete guide on how to use dash:gobject_diff json-rpc in GetBlock.io Web3 documentation.
---
