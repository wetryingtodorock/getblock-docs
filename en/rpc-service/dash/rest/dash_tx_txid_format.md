---
title: /tx/{txid}{format} - Dash
description: Example code for the /tx/{txid}{format} rest method. Сomplete guide on how to use /tx/{txid}{format} rest in GetBlock.io Web3 documentation.
---
