...
description: Example code for the hmy_getStorageAt json-rpc method. Сomplete guide on how to use hmy_getStorageAt json-rpc in GetBlock.io Web3 documentation.
---
