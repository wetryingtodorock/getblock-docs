---
title: one:hmy_sendTransaction  {disallowed} - Harmony
description: Example code for the one:hmy_sendTransaction  {disallowed} json-rpc method. Сomplete guide on how to use one:hmy_sendTransaction  {disallowed} json-rpc in GetBlock.io Web3 documentation.
---
