---
title: one:hmyv2_getBlockByNumber - Harmony
description: Example code for the one:hmyv2_getBlockByNumber json-rpc method. Сomplete guide on how to use one:hmyv2_getBlockByNumber json-rpc in GetBlock.io Web3 documentation.
---
