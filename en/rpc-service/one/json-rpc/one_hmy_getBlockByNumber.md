---
title: one:hmy_getBlockByNumber - Harmony
description: Example code for the one:hmy_getBlockByNumber json-rpc method. Сomplete guide on how to use one:hmy_getBlockByNumber json-rpc in GetBlock.io Web3 documentation.
---
