---
title: btg:getblocktemplate - Bitcoin Gold
description: Example code for the btg:getblocktemplate json-rpc method. Сomplete guide on how to use btg:getblocktemplate json-rpc in GetBlock.io Web3 documentation.
---
