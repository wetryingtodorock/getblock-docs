---
title: btg:sendmany  {disallowed} - Bitcoin Gold
description: Example code for the btg:sendmany  {disallowed} json-rpc method. Сomplete guide on how to use btg:sendmany  {disallowed} json-rpc in GetBlock.io Web3 documentation.
---
