---
title: btg:converttopsbt - Bitcoin Gold
description: Example code for the btg:converttopsbt json-rpc method. Сomplete guide on how to use btg:converttopsbt json-rpc in GetBlock.io Web3 documentation.
---
