---
title: btg:getrawtransaction - Bitcoin Gold
description: Example code for the btg:getrawtransaction json-rpc method. Сomplete guide on how to use btg:getrawtransaction json-rpc in GetBlock.io Web3 documentation.
---
