---
title: btg:estimatesmartfee - Bitcoin Gold
description: Example code for the btg:estimatesmartfee json-rpc method. Сomplete guide on how to use btg:estimatesmartfee json-rpc in GetBlock.io Web3 documentation.
---
