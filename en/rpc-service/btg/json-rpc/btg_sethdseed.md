---
title: btg:sethdseed  {disallowed} - Bitcoin Gold
description: Example code for the btg:sethdseed  {disallowed} json-rpc method. Сomplete guide on how to use btg:sethdseed  {disallowed} json-rpc in GetBlock.io Web3 documentation.
---
