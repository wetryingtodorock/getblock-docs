---
title: btg:generateblock  {disallowed} - Bitcoin Gold
description: Example code for the btg:generateblock  {disallowed} json-rpc method. Сomplete guide on how to use btg:generateblock  {disallowed} json-rpc in GetBlock.io Web3 documentation.
---
