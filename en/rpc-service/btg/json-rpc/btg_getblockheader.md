---
title: btg:getblockheader - Bitcoin Gold
description: Example code for the btg:getblockheader json-rpc method. Сomplete guide on how to use btg:getblockheader json-rpc in GetBlock.io Web3 documentation.
---
