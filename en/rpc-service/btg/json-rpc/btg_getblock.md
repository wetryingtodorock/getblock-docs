---
title: btg:getblock - Bitcoin Gold
description: Example code for the btg:getblock json-rpc method. Сomplete guide on how to use btg:getblock json-rpc in GetBlock.io Web3 documentation.
---
