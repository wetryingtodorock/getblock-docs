---
title: btg:listsinceblock  {disallowed} - Bitcoin Gold
description: Example code for the btg:listsinceblock  {disallowed} json-rpc method. Сomplete guide on how to use btg:listsinceblock  {disallowed} json-rpc in GetBlock.io Web3 documentation.
---
