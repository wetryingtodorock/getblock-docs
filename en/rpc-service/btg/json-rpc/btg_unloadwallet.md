---
title: btg:unloadwallet  {disallowed} - Bitcoin Gold
description: Example code for the btg:unloadwallet  {disallowed} json-rpc method. Сomplete guide on how to use btg:unloadwallet  {disallowed} json-rpc in GetBlock.io Web3 documentation.
---
