---
title: heco:eth_getTransactionReceipt - Huobi ECO Chain
description: Example code for the heco:eth_getTransactionReceipt json-rpc method. Сomplete guide on how to use heco:eth_getTransactionReceipt json-rpc in GetBlock.io Web3 documentation.
---
