...
description: Example code for the heco:eth_submitHashrate  {disallowed} json-rpc method. Сomplete guide on how to use heco:eth_submitHashrate  {disallowed} json-rpc in GetBlock.io Web3 documentation.
---
