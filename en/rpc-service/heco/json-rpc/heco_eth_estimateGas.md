---
title: heco:eth_estimateGas - Huobi ECO Chain
description: Example code for the heco:eth_estimateGas json-rpc method. Сomplete guide on how to use heco:eth_estimateGas json-rpc in GetBlock.io Web3 documentation.
---
