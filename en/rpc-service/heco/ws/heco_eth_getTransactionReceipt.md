...
description: Example code for the heco:eth_getTransactionReceipt ws method. Сomplete guide on how to use heco:eth_getTransactionReceipt ws in GetBlock.io Web3 documentation.
---
