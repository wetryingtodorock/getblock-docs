---
title: fuse:eth_subscribe - Fuse Network
description: Example code for the fuse:eth_subscribe json-rpc method. Сomplete guide on how to use fuse:eth_subscribe json-rpc in GetBlock.io Web3 documentation.
---
