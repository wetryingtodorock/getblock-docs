---
title: fuse:eth_estimateGas - Fuse Network
description: Example code for the fuse:eth_estimateGas json-rpc method. Сomplete guide on how to use fuse:eth_estimateGas json-rpc in GetBlock.io Web3 documentation.
---
