---
title: eth_signTransaction - Fuse Network
description: Example code for the eth_signTransaction json-rpc method. Сomplete guide on how to use eth_signTransaction json-rpc in GetBlock.io Web3 documentation.
---
