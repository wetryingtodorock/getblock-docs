...
description: Example code for the fuse:eth_getBlockByHash json-rpc method. Сomplete guide on how to use fuse:eth_getBlockByHash json-rpc in GetBlock.io Web3 documentation.
---
