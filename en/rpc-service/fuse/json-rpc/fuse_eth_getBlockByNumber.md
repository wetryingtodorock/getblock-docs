---
title: fuse:eth_getBlockByNumber - Fuse Network
description: Example code for the fuse:eth_getBlockByNumber json-rpc method. Сomplete guide on how to use fuse:eth_getBlockByNumber json-rpc in GetBlock.io Web3 documentation.
---
