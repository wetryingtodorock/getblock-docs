...
description: Example code for the fuse:eth_getTransactionByHash ws method. Сomplete guide on how to use fuse:eth_getTransactionByHash ws in GetBlock.io Web3 documentation.
---
