...
description: Example code for the fuse:eth_signTransaction ws method. Сomplete guide on how to use fuse:eth_signTransaction ws in GetBlock.io Web3 documentation.
---
