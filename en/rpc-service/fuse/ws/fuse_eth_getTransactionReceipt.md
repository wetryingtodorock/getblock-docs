...
description: Example code for the fuse:eth_getTransactionReceipt ws method. Сomplete guide on how to use fuse:eth_getTransactionReceipt ws in GetBlock.io Web3 documentation.
---
