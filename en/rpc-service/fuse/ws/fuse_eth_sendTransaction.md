...
description: Example code for the fuse:eth_sendTransaction ws method. Сomplete guide on how to use fuse:eth_sendTransaction ws in GetBlock.io Web3 documentation.
---
