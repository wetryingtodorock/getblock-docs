---
title: query(view_code) - NEAR Protocol
description: Example code for the query(view_code) json-rpc method. Сomplete guide on how to use query(view_code) json-rpc in GetBlock.io Web3 documentation.
---
