---
title: near:validators - NEAR Protocol
description: Example code for the near:validators json-rpc method. Сomplete guide on how to use near:validators json-rpc in GetBlock.io Web3 documentation.
---
