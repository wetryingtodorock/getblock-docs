---
title: theta.GetStatus - Theta Network
description: Example code for the theta.GetStatus json-rpc method. Сomplete guide on how to use theta.GetStatus json-rpc in GetBlock.io Web3 documentation.
---
