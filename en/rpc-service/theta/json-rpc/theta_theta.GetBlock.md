---
title: theta.GetBlock - Theta Network
description: Example code for the theta.GetBlock json-rpc method. Сomplete guide on how to use theta.GetBlock json-rpc in GetBlock.io Web3 documentation.
---
