...
description: Example code for the matic:shh_newFilter  {disallowed} json-rpc method. Сomplete guide on how to use matic:shh_newFilter  {disallowed} json-rpc in GetBlock.io Web3 documentation.
---
