...
description: Example code for the matic:eth_estimateGas json-rpc method. Сomplete guide on how to use matic:eth_estimateGas json-rpc in GetBlock.io Web3 documentation.
---
