...
description: Example code for the matic:eth_getTransactionByHash json-rpc method. Сomplete guide on how to use matic:eth_getTransactionByHash json-rpc in GetBlock.io Web3 documentation.
---
