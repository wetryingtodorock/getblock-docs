...
description: Example code for the matic:eth_getTransactionByBlockHashAndIndex ws method. Сomplete guide on how to use matic:eth_getTransactionByBlockHashAndIndex ws in GetBlock.io Web3 documentation.
---
