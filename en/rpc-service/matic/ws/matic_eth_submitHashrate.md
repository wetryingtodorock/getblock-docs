...
description: Example code for the matic:eth_submitHashrate  {disallowed} ws method. Сomplete guide on how to use matic:eth_submitHashrate  {disallowed} ws in GetBlock.io Web3 documentation.
---
