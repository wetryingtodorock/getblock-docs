...
description: Example code for the kcc:eth_getTransactionByHash ws method. Сomplete guide on how to use kcc:eth_getTransactionByHash ws in GetBlock.io Web3 documentation.
---
