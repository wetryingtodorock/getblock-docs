...
description: Example code for the kcc:eth_getBlockByNumber ws method. Сomplete guide on how to use kcc:eth_getBlockByNumber ws in GetBlock.io Web3 documentation.
---
