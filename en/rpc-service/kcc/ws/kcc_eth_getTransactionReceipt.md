...
description: Example code for the kcc:eth_getTransactionReceipt ws method. Сomplete guide on how to use kcc:eth_getTransactionReceipt ws in GetBlock.io Web3 documentation.
---
