---
title: kcc:eth_getTransactionByHash - KuCoin Community Chain
description: Example code for the kcc:eth_getTransactionByHash json-rpc method. Сomplete guide on how to use kcc:eth_getTransactionByHash json-rpc in GetBlock.io Web3 documentation.
---
