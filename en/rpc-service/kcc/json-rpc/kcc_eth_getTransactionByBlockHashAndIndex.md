...
description: Example code for the kcc:eth_getTransactionByBlockHashAndIndex json-rpc method. Сomplete guide on how to use kcc:eth_getTransactionByBlockHashAndIndex json-rpc in GetBlock.io Web3 documentation.
---
