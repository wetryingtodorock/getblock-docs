...
description: Example code for the kcc:eth_signTransaction  {disallowed} json-rpc method. Сomplete guide on how to use kcc:eth_signTransaction  {disallowed} json-rpc in GetBlock.io Web3 documentation.
---
