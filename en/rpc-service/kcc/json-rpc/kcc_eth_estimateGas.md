---
title: kcc:eth_estimateGas - KuCoin Community Chain
description: Example code for the kcc:eth_estimateGas json-rpc method. Сomplete guide on how to use kcc:eth_estimateGas json-rpc in GetBlock.io Web3 documentation.
---
