---
title: apt:/v1/transactions - Aptos
description: Example code for the apt:/v1/transactions json-rpc method. Сomplete guide on how to use apt:/v1/transactions json-rpc in GetBlock.io Web3 documentation.
---
