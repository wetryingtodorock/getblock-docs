---
title: apt:/v1/accounts/{account_hash}/resource/{resource_type} - Aptos
description: Example code for the apt:/v1/accounts/{account_hash}/resource/{resource_type} json-rpc method. Сomplete guide on how to use apt:/v1/accounts/{account_hash}/resource/{resource_type} json-rpc in GetBlock.io Web3 documentation.
---
