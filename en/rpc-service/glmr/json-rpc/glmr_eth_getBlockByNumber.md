---
title: glmr:eth_getBlockByNumber - Moonbeam
description: Example code for the glmr:eth_getBlockByNumber json-rpc method. Сomplete guide on how to use glmr:eth_getBlockByNumber json-rpc in GetBlock.io Web3 documentation.
---
