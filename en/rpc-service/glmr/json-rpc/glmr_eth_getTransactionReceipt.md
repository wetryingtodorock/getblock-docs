---
title: glmr:eth_getTransactionReceipt - Moonbeam
description: Example code for the glmr:eth_getTransactionReceipt json-rpc method. Сomplete guide on how to use glmr:eth_getTransactionReceipt json-rpc in GetBlock.io Web3 documentation.
---
