---
title: glmr:eth_getLogs - Moonbeam
description: Example code for the glmr:eth_getLogs json-rpc method. Сomplete guide on how to use glmr:eth_getLogs json-rpc in GetBlock.io Web3 documentation.
---
