...
description: Example code for the eth:eth_getUncleCountByBlockNumber ws method. Сomplete guide on how to use eth:eth_getUncleCountByBlockNumber ws in GetBlock.io Web3 documentation.
---
