...
description: Example code for the clique_getSignerMetrics  {disallowed} ws method. Сomplete guide on how to use clique_getSignerMetrics  {disallowed} ws in GetBlock.io Web3 documentation.
---
