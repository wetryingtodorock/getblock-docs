...
description: Example code for the eth:debug_accountRange  {disallowed} ws method. Сomplete guide on how to use eth:debug_accountRange  {disallowed} ws in GetBlock.io Web3 documentation.
---
