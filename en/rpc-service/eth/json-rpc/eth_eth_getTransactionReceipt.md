...
description: Example code for the eth:eth_getTransactionReceipt json-rpc method. Сomplete guide on how to use eth:eth_getTransactionReceipt json-rpc in GetBlock.io Web3 documentation.
---
