...
description: Example code for the eth:ibft_getSignerMetrics  {disallowed} json-rpc method. Сomplete guide on how to use eth:ibft_getSignerMetrics  {disallowed} json-rpc in GetBlock.io Web3 documentation.
---
