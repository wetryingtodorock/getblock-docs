---
title: getblocksubsidy - Zcash
description: Example code for the getblocksubsidy json-rpc method. Сomplete guide on how to use getblocksubsidy json-rpc in GetBlock.io Web3 documentation.
---
