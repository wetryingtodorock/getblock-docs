---
title: zec:getchaintips - Zcash
description: Example code for the zec:getchaintips json-rpc method. Сomplete guide on how to use zec:getchaintips json-rpc in GetBlock.io Web3 documentation.
---
