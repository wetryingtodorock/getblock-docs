...
description: Example code for the gno:eth_getTransactionReceipt ws method. Сomplete guide on how to use gno:eth_getTransactionReceipt ws in GetBlock.io Web3 documentation.
---
