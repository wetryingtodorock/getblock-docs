...
description: Example code for the gno:eth_getTransactionByBlockHashAndIndex ws method. Сomplete guide on how to use gno:eth_getTransactionByBlockHashAndIndex ws in GetBlock.io Web3 documentation.
---
