---
title: gno:eth_getTransactionReceipt - Gnosis
description: Example code for the gno:eth_getTransactionReceipt json-rpc method. Сomplete guide on how to use gno:eth_getTransactionReceipt json-rpc in GetBlock.io Web3 documentation.
---
