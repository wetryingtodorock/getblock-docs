...
description: Example code for the gno:eth_unsubscribe json-rpc method. Сomplete guide on how to use gno:eth_unsubscribe json-rpc in GetBlock.io Web3 documentation.
---
