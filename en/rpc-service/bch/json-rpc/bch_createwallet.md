---
title: bch:createwallet  {disallowed} - Bitcoin Cash
description: Example code for the bch:createwallet  {disallowed} json-rpc method. Сomplete guide on how to use bch:createwallet  {disallowed} json-rpc in GetBlock.io Web3 documentation.
---
