---
title: bch:sendtoaddress  {disallowed} - Bitcoin Cash
description: Example code for the bch:sendtoaddress  {disallowed} json-rpc method. Сomplete guide on how to use bch:sendtoaddress  {disallowed} json-rpc in GetBlock.io Web3 documentation.
---
