---
title: bch:unloadwallet  {disallowed} - Bitcoin Cash
description: Example code for the bch:unloadwallet  {disallowed} json-rpc method. Сomplete guide on how to use bch:unloadwallet  {disallowed} json-rpc in GetBlock.io Web3 documentation.
---
