---
title: bch:converttopsbt - Bitcoin Cash
description: Example code for the bch:converttopsbt json-rpc method. Сomplete guide on how to use bch:converttopsbt json-rpc in GetBlock.io Web3 documentation.
---
