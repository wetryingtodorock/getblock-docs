---
title: bch:listtransactions  {disallowed} - Bitcoin Cash
description: Example code for the bch:listtransactions  {disallowed} json-rpc method. Сomplete guide on how to use bch:listtransactions  {disallowed} json-rpc in GetBlock.io Web3 documentation.
---
