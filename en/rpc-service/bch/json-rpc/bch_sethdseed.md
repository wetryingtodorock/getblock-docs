---
title: bch:sethdseed  {disallowed} - Bitcoin Cash
description: Example code for the bch:sethdseed  {disallowed} json-rpc method. Сomplete guide on how to use bch:sethdseed  {disallowed} json-rpc in GetBlock.io Web3 documentation.
---
