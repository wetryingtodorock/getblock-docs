---
title: bch:fundrawtransaction - Bitcoin Cash
description: Example code for the bch:fundrawtransaction json-rpc method. Сomplete guide on how to use bch:fundrawtransaction json-rpc in GetBlock.io Web3 documentation.
---
