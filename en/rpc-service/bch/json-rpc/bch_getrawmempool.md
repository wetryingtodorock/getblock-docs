---
title: bch:getrawmempool - Bitcoin Cash
description: Example code for the bch:getrawmempool json-rpc method. Сomplete guide on how to use bch:getrawmempool json-rpc in GetBlock.io Web3 documentation.
---
