...
Given a transaction hash: returns a transaction in binary, hex-encoded
...
``` java
curl --location --request GET 'https://bch.getblock.io/mainnet/rest/tx/33be25aff408d7d86a2a543af4a1440a154a7243839401a3b906d61ea72fb840.json' \
