---
title: get_alternate_chains - Monero
description: Example code for the get_alternate_chains json-rpc method. Сomplete guide on how to use get_alternate_chains json-rpc in GetBlock.io Web3 documentation.
---
