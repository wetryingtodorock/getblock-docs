---
title: getmerkleproof - Ontology
description: Example code for the getmerkleproof json-rpc method. Сomplete guide on how to use getmerkleproof json-rpc in GetBlock.io Web3 documentation.
---
