---
title: ont:getblock - Ontology
description: Example code for the ont:getblock json-rpc method. Сomplete guide on how to use ont:getblock json-rpc in GetBlock.io Web3 documentation.
---
