---
title: /api/v1/block/details/hash/{hash} - Ontology
description: Example code for the /api/v1/block/details/hash/{hash} rest method. Сomplete guide on how to use /api/v1/block/details/hash/{hash} rest in GetBlock.io Web3 documentation.
---
