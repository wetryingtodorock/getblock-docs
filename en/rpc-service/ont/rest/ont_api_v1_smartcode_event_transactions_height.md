---
title: /api/v1/smartcode/event/transactions/{height} - Ontology
description: Example code for the /api/v1/smartcode/event/transactions/{height} rest method. Сomplete guide on how to use /api/v1/smartcode/event/transactions/{height} rest in GetBlock.io Web3 documentation.
---
