---
title: ont:/api/v1/smartcode/event/txhash/{hash} - Ontology
description: Example code for the ont:/api/v1/smartcode/event/txhash/{hash} rest method. Сomplete guide on how to use ont:/api/v1/smartcode/event/txhash/{hash} rest in GetBlock.io Web3 documentation.
---
