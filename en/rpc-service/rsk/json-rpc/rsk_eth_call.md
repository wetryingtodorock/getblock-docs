---
title: rsk:eth_call - Rootstock
description: Example code for the rsk:eth_call json-rpc method. Сomplete guide on how to use rsk:eth_call json-rpc in GetBlock.io Web3 documentation.
---
