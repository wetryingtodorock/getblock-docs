...
description: Example code for the rsk:eth_getTransactionByBlockNumberAndIndex ws method. Сomplete guide on how to use rsk:eth_getTransactionByBlockNumberAndIndex ws in GetBlock.io Web3 documentation.
---
