...
description: Example code for the rsk:eth_sendTransaction ws method. Сomplete guide on how to use rsk:eth_sendTransaction ws in GetBlock.io Web3 documentation.
---
