...
description: Example code for the rsk:eth_getTransactionByBlockHashAndIndex ws method. Сomplete guide on how to use rsk:eth_getTransactionByBlockHashAndIndex ws in GetBlock.io Web3 documentation.
---
