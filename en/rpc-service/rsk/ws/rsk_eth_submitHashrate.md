...
description: Example code for the rsk:eth_submitHashrate  {disallowed} ws method. Сomplete guide on how to use rsk:eth_submitHashrate  {disallowed} ws in GetBlock.io Web3 documentation.
---
