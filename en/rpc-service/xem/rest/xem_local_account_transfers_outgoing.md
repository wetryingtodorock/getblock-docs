---
title: /local/account/transfers/outgoing  {disallowed} - NEM
description: Example code for the /local/account/transfers/outgoing  {disallowed} rest method. Сomplete guide on how to use /local/account/transfers/outgoing  {disallowed} rest in GetBlock.io Web3 documentation.
---
