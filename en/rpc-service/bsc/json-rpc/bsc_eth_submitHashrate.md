...
description: Example code for the bsc:eth_submitHashrate  {disallowed} json-rpc method. Сomplete guide on how to use bsc:eth_submitHashrate  {disallowed} json-rpc in GetBlock.io Web3 documentation.
---
