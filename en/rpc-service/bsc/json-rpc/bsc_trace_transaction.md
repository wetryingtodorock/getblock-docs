...
description: Example code for the bsc:trace_transaction json-rpc method. Сomplete guide on how to use bsc:trace_transaction json-rpc in GetBlock.io Web3 documentation.
---
