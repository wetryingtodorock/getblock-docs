...
description: Example code for the bsc:eth_getTransactionReceipt json-rpc method. Сomplete guide on how to use bsc:eth_getTransactionReceipt json-rpc in GetBlock.io Web3 documentation.
---
