---
title: bsc:eth_subscribe - Binance Smart Chain
description: Example code for the bsc:eth_subscribe json-rpc method. Сomplete guide on how to use bsc:eth_subscribe json-rpc in GetBlock.io Web3 documentation.
---
