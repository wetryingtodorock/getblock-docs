...
description: Example code for the bsc:eth_getStorageAt ws method. Сomplete guide on how to use bsc:eth_getStorageAt ws in GetBlock.io Web3 documentation.
---
