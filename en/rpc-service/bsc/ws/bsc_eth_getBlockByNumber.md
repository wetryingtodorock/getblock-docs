...
description: Example code for the bsc:eth_getBlockByNumber ws method. Сomplete guide on how to use bsc:eth_getBlockByNumber ws in GetBlock.io Web3 documentation.
---
