...
description: Example code for the bsc:eth_sendTransaction  {disallowed} ws method. Сomplete guide on how to use bsc:eth_sendTransaction  {disallowed} ws in GetBlock.io Web3 documentation.
---
