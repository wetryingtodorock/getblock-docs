...
description: Example code for the bsc:debug_accountRange  {disallowed} ws method. Сomplete guide on how to use bsc:debug_accountRange  {disallowed} ws in GetBlock.io Web3 documentation.
---
