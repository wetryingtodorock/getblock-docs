...
description: Example code for the arbitrum:web3_sha3 json-rpc method. Сomplete guide on how to use arbitrum:web3_sha3 json-rpc in GetBlock.io Web3 documentation.
---
