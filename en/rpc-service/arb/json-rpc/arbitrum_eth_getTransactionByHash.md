...
description: Example code for the arbitrum:eth_getTransactionByHash json-rpc method. Сomplete guide on how to use arbitrum:eth_getTransactionByHash json-rpc in GetBlock.io Web3 documentation.
---
