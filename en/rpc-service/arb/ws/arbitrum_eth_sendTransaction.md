...
description: Example code for the arbitrum:eth_sendTransaction ws method. Сomplete guide on how to use arbitrum:eth_sendTransaction ws in GetBlock.io Web3 documentation.
---
