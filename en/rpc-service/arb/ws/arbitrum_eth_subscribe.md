...
description: Example code for the arbitrum:eth_subscribe ws method. Сomplete guide on how to use arbitrum:eth_subscribe ws in GetBlock.io Web3 documentation.
---
