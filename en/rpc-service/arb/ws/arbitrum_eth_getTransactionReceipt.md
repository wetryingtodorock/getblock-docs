...
description: Example code for the arbitrum:eth_getTransactionReceipt ws method. Сomplete guide on how to use arbitrum:eth_getTransactionReceipt ws in GetBlock.io Web3 documentation.
---
