...
description: Example code for the arbitrum:shh_newFilter  {disallowed} ws method. Сomplete guide on how to use arbitrum:shh_newFilter  {disallowed} ws in GetBlock.io Web3 documentation.
---
