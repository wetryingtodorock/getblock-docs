...
description: Example code for the arbitrum:eth_signTransaction ws method. Сomplete guide on how to use arbitrum:eth_signTransaction ws in GetBlock.io Web3 documentation.
---
