---
title: ton:/getAddressInformation - The Open Network (TON)
description: Example code for the ton:/getAddressInformation json-rpc method. Сomplete guide on how to use ton:/getAddressInformation json-rpc in GetBlock.io Web3 documentation.
---
