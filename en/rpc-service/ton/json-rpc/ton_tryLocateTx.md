---
title: /tryLocateTx - The Open Network (TON)
description: Example code for the /tryLocateTx json-rpc method. Сomplete guide on how to use /tryLocateTx json-rpc in GetBlock.io Web3 documentation.
---
