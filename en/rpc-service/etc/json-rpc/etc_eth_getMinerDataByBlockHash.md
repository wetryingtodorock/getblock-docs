---
title: etc:eth_getMinerDataByBlockHash - Ethereum Classic
description: Example code for the etc:eth_getMinerDataByBlockHash json-rpc method. Сomplete guide on how to use etc:eth_getMinerDataByBlockHash json-rpc in GetBlock.io Web3 documentation.
---
