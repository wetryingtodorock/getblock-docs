---
title: etc:eth_getFilterChanges - Ethereum Classic
description: Example code for the etc:eth_getFilterChanges json-rpc method. Сomplete guide on how to use etc:eth_getFilterChanges json-rpc in GetBlock.io Web3 documentation.
---
