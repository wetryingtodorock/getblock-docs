---
title: optimism:eth_estimateGas - Optimism
description: Example code for the optimism:eth_estimateGas json-rpc method. Сomplete guide on how to use optimism:eth_estimateGas json-rpc in GetBlock.io Web3 documentation.
---
