...
description: Example code for the optimism:eth_signTransaction  {disallowed} ws method. Сomplete guide on how to use optimism:eth_signTransaction  {disallowed} ws in GetBlock.io Web3 documentation.
---
