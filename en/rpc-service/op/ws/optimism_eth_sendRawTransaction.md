...
description: Example code for the optimism:eth_sendRawTransaction ws method. Сomplete guide on how to use optimism:eth_sendRawTransaction ws in GetBlock.io Web3 documentation.
---
