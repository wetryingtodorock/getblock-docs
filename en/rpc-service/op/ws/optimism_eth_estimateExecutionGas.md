...
description: Example code for the optimism:eth_estimateExecutionGas ws method. Сomplete guide on how to use optimism:eth_estimateExecutionGas ws in GetBlock.io Web3 documentation.
---
