...
description: Example code for the optimism:eth_estimateGas ws method. Сomplete guide on how to use optimism:eth_estimateGas ws in GetBlock.io Web3 documentation.
---
