...
description: Example code for the optimism:eth_getBlockByNumber ws method. Сomplete guide on how to use optimism:eth_getBlockByNumber ws in GetBlock.io Web3 documentation.
---
