...
description: Example code for the optimism:eth_sendTransaction  {disallowed} ws method. Сomplete guide on how to use optimism:eth_sendTransaction  {disallowed} ws in GetBlock.io Web3 documentation.
---
