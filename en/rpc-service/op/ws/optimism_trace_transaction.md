...
description: Example code for the optimism:trace_transaction ws method. Сomplete guide on how to use optimism:trace_transaction ws in GetBlock.io Web3 documentation.
---
