---
title: ftm:eth_sendTransaction  {disallowed} - Fantom
description: Example code for the ftm:eth_sendTransaction  {disallowed} json-rpc method. Сomplete guide on how to use ftm:eth_sendTransaction  {disallowed} json-rpc in GetBlock.io Web3 documentation.
---
