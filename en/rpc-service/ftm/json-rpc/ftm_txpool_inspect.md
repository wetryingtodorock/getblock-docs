---
title: ftm:txpool_inspect - Fantom
description: Example code for the ftm:txpool_inspect json-rpc method. Сomplete guide on how to use ftm:txpool_inspect json-rpc in GetBlock.io Web3 documentation.
---
