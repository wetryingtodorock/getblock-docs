---
title: ftm:dag_getEventPayload - Fantom
description: Example code for the ftm:dag_getEventPayload json-rpc method. Сomplete guide on how to use ftm:dag_getEventPayload json-rpc in GetBlock.io Web3 documentation.
---
...
Boolean value, returns the full transaction objects if true and only the
hashes of the transactions if false.
