---
title: bsv:createmultisig  {disallowed} - Bitcoin SV
description: Example code for the bsv:createmultisig  {disallowed} json-rpc method. Сomplete guide on how to use bsv:createmultisig  {disallowed} json-rpc in GetBlock.io Web3 documentation.
---
