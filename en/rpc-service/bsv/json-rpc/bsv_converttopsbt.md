---
title: bsv:converttopsbt - Bitcoin SV
description: Example code for the bsv:converttopsbt json-rpc method. Сomplete guide on how to use bsv:converttopsbt json-rpc in GetBlock.io Web3 documentation.
---
