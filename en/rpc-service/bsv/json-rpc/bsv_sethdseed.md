---
title: bsv:sethdseed  {disallowed} - Bitcoin SV
description: Example code for the bsv:sethdseed  {disallowed} json-rpc method. Сomplete guide on how to use bsv:sethdseed  {disallowed} json-rpc in GetBlock.io Web3 documentation.
---
