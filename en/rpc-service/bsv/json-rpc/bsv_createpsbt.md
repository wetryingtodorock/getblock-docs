---
title: bsv:createpsbt - Bitcoin SV
description: Example code for the bsv:createpsbt json-rpc method. Сomplete guide on how to use bsv:createpsbt json-rpc in GetBlock.io Web3 documentation.
---
