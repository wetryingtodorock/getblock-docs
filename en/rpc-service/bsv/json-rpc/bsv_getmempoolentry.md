---
title: bsv:getmempoolentry - Bitcoin SV
description: Example code for the bsv:getmempoolentry json-rpc method. Сomplete guide on how to use bsv:getmempoolentry json-rpc in GetBlock.io Web3 documentation.
---
