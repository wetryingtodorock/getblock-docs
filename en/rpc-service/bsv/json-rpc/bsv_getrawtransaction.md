---
title: bsv:getrawtransaction - Bitcoin SV
description: Example code for the bsv:getrawtransaction json-rpc method. Сomplete guide on how to use bsv:getrawtransaction json-rpc in GetBlock.io Web3 documentation.
---
