---
title: bsv:getblocktemplate - Bitcoin SV
description: Example code for the bsv:getblocktemplate json-rpc method. Сomplete guide on how to use bsv:getblocktemplate json-rpc in GetBlock.io Web3 documentation.
---
