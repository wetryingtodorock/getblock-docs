---
title: dot:chain_getBlock - Polkadot
description: Example code for the dot:chain_getBlock json-rpc method. Сomplete guide on how to use dot:chain_getBlock json-rpc in GetBlock.io Web3 documentation.
---
