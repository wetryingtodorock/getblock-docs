---
title: btc:getrawmempool - Bitcoin
description: Example code for the btc:getrawmempool json-rpc method. Сomplete guide on how to use btc:getrawmempool json-rpc in GetBlock.io Web3 documentation.
---
