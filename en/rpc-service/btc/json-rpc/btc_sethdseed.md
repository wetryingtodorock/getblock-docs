---
title: btc:sethdseed  {disallowed} - Bitcoin
description: Example code for the btc:sethdseed  {disallowed} json-rpc method. Сomplete guide on how to use btc:sethdseed  {disallowed} json-rpc in GetBlock.io Web3 documentation.
---
