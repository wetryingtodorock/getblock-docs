---
title: btc:getmempoolentry - Bitcoin
description: Example code for the btc:getmempoolentry json-rpc method. Сomplete guide on how to use btc:getmempoolentry json-rpc in GetBlock.io Web3 documentation.
---
