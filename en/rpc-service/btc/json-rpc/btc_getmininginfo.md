---
title: btc:getmininginfo - Bitcoin
description: Example code for the btc:getmininginfo json-rpc method. Сomplete guide on how to use btc:getmininginfo json-rpc in GetBlock.io Web3 documentation.
---
