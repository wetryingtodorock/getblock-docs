---
title: btc:fundrawtransaction - Bitcoin
description: Example code for the btc:fundrawtransaction json-rpc method. Сomplete guide on how to use btc:fundrawtransaction json-rpc in GetBlock.io Web3 documentation.
---
