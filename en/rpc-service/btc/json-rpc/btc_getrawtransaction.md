---
title: btc:getrawtransaction - Bitcoin
description: Example code for the btc:getrawtransaction json-rpc method. Сomplete guide on how to use btc:getrawtransaction json-rpc in GetBlock.io Web3 documentation.
---
