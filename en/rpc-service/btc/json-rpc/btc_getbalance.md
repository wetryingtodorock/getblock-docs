---
title: btc:getbalance  {disallowed} - Bitcoin
description: Example code for the btc:getbalance  {disallowed} json-rpc method. Сomplete guide on how to use btc:getbalance  {disallowed} json-rpc in GetBlock.io Web3 documentation.
---
