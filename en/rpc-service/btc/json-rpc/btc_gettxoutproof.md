---
title: btc:gettxoutproof - Bitcoin
description: Example code for the btc:gettxoutproof json-rpc method. Сomplete guide on how to use btc:gettxoutproof json-rpc in GetBlock.io Web3 documentation.
---
