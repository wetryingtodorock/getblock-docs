---
title: dgb:converttopsbt - DigiByte
description: Example code for the dgb:converttopsbt json-rpc method. Сomplete guide on how to use dgb:converttopsbt json-rpc in GetBlock.io Web3 documentation.
---
