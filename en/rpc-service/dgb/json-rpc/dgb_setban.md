---
title: dgb:setban  {disallowed} - DigiByte
description: Example code for the dgb:setban  {disallowed} json-rpc method. Сomplete guide on how to use dgb:setban  {disallowed} json-rpc in GetBlock.io Web3 documentation.
---
