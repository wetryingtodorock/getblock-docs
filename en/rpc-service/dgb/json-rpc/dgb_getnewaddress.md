---
title: dgb:getnewaddress  {disallowed} - DigiByte
description: Example code for the dgb:getnewaddress  {disallowed} json-rpc method. Сomplete guide on how to use dgb:getnewaddress  {disallowed} json-rpc in GetBlock.io Web3 documentation.
---
