---
title: dgb:getchaintips - DigiByte
description: Example code for the dgb:getchaintips json-rpc method. Сomplete guide on how to use dgb:getchaintips json-rpc in GetBlock.io Web3 documentation.
---
