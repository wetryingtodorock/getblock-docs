---
title: dgb:signrawtransactionwithkey - DigiByte
description: Example code for the dgb:signrawtransactionwithkey json-rpc method. Сomplete guide on how to use dgb:signrawtransactionwithkey json-rpc in GetBlock.io Web3 documentation.
---
