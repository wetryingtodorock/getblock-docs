---
title: dgb:listsinceblock  {disallowed} - DigiByte
description: Example code for the dgb:listsinceblock  {disallowed} json-rpc method. Сomplete guide on how to use dgb:listsinceblock  {disallowed} json-rpc in GetBlock.io Web3 documentation.
---
