---
title: dgb:getblock - DigiByte
description: Example code for the dgb:getblock json-rpc method. Сomplete guide on how to use dgb:getblock json-rpc in GetBlock.io Web3 documentation.
---
