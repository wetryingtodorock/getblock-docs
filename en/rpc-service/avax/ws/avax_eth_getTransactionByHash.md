...
description: Example code for the avax:eth_getTransactionByHash ws method. Сomplete guide on how to use avax:eth_getTransactionByHash ws in GetBlock.io Web3 documentation.
---
