...
description: Example code for the avax:eth_getBlockRange  {disallowed} ws method. Сomplete guide on how to use avax:eth_getBlockRange  {disallowed} ws in GetBlock.io Web3 documentation.
---
