...
description: Example code for the avax:avax.import  {disallowed} ws method. Сomplete guide on how to use avax:avax.import  {disallowed} ws in GetBlock.io Web3 documentation.
---
