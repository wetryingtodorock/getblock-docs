...
description: Example code for the avax:eth_sendTransaction  {disallowed} ws method. Сomplete guide on how to use avax:eth_sendTransaction  {disallowed} ws in GetBlock.io Web3 documentation.
---
