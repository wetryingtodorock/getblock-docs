...
description: Example code for the avax:eth_getTransactionReceipt json-rpc method. Сomplete guide on how to use avax:eth_getTransactionReceipt json-rpc in GetBlock.io Web3 documentation.
---
