---
title: avax:eth_getChainConfig - Avalanche
description: Example code for the avax:eth_getChainConfig json-rpc method. Сomplete guide on how to use avax:eth_getChainConfig json-rpc in GetBlock.io Web3 documentation.
---
