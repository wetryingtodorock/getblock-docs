...
description: Example code for the avax:avax.export  {disallowed} json-rpc method. Сomplete guide on how to use avax:avax.export  {disallowed} json-rpc in GetBlock.io Web3 documentation.
---
