...
description: Example code for the debug_traceCall json-rpc method. Сomplete guide on how to use debug_traceCall json-rpc in GetBlock.io Web3 documentation.
---
