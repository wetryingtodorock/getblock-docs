---
title: eth_getBlockReceipts - Harmony
description: Example code for the eth_getBlockReceipts json-rpc method. Сomplete guide on how to use eth_getBlockReceipts json-rpc in GetBlock.io Web3 documentation.
---
