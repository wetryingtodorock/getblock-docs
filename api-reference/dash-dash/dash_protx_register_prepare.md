---
title: protx_register_prepare  {disallowed} - Dash
description: Example code for the protx_register_prepare  {disallowed} json-rpc method. Сomplete guide on how to use protx_register_prepare  {disallowed} json-rpc in GetBlock.io Web3 documentation.
---
