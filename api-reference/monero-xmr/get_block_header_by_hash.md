---
title: get_block_header_by_hash - Monero
description: Example code for the get_block_header_by_hash json-rpc method. Сomplete guide on how to use get_block_header_by_hash json-rpc in GetBlock.io Web3 documentation.
---
