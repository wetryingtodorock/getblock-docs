---
title: /api/v1/merkleproof/{hash} - Ontology
description: Example code for the /api/v1/merkleproof/{hash} rest method. Сomplete guide on how to use /api/v1/merkleproof/{hash} rest in GetBlock.io Web3 documentation.
---
