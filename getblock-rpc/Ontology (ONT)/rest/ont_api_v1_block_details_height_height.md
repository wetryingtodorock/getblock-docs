---
title: /api/v1/block/details/height/{height} - Ontology
description: Example code for the /api/v1/block/details/height/{height} rest method. Сomplete guide on how to use /api/v1/block/details/height/{height} rest in GetBlock.io Web3 documentation.
---
...
``` java
curl --location --request GET 'https://ont.getblock.io/mainnet/rest/api/v1/block/details/height/16242872' 
